...
//    { "omx_dummy",          "libOMX_Core.so",           "OMX.TI.DUCATI1.MISC.SAMPLE",   NULL,                   GST_RANK_NONE,      gst_omx_dummy_get_type },
    ...
    { "legacy_omx_h264dec",        "libOMX_Core.so",           "OMX.TI.DUCATI.VIDDEC", "",    GST_RANK_PRIMARY,   gst_omx_h264dec_get_type },
    { "omx_mjpegdec",       "libOMX_Core.so",           "OMX.TI.DUCATI.VIDDEC", "",    GST_RANK_PRIMARY,   gst_omx_mjpegdec_get_type },
    { "legacy_omx_mpeg2dec",       "libOMX_Core.so",           "OMX.TI.DUCATI.VIDDEC", "",  GST_RANK_PRIMARY ,   gst_omx_mpeg2dec_get_type },
...
//    { "omx_amrwbenc",       "libomxil-bellagio.so.0",   "OMX.st.audio_encoder.amrwb",   NULL,                   GST_RANK_NONE,   gst_omx_amrwbenc_get_type },
    { "legacy_omx_aacdec",         "libOMX_Core.so",           "OMX.TI.DSP.AUDDEC", "", GST_RANK_NONE,   gst_omx_aacdec_get_type },
      { "legacy_omx_aacenc",         "libOMX_Core.so",           "OMX.TI.DSP.AUDENC",          "", GST_RANK_NONE,   gst_omx_aacenc_get_type },
...
//    { "omx_volume",         "libomxil-bellagio.so.0",   "OMX.st.volume.component",      NULL,                   GST_RANK_NONE,      gst_omx_volume_get_type },
    ...
    { "legacy_omx_noisefilter",         "libOMX_Core.so",   "OMX.TI.VPSSM3.VFPC.NF",     "",                   GST_RANK_PRIMARY,      gst_omx_noisefilter_get_type },
